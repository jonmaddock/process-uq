...
class InDat(object):
    ...
    def process_line(self, line_type, line):
        ...
        # Arrays
            ...
            # It's possible empty_array is a float in the dicts, when it's
            # actually an array in Fortran, initialised as:
            # rjconpf = 3.0D7
            # This needs correcting to a list here
            if type(empty_array) is float:
